...
class EducationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create education" do
    assert_difference('Education.count') do
      post educations_url, params: { education: { aggregate: @education.aggregate, college: @education.college, completion_date: @education.completion_date, course: @education.course, join_date: @education.join_date } }
    end
  ...
  test "should update education" do
    patch education_url(@education), params: { education: { aggregate: @education.aggregate, college: @education.college, completion_date: @education.completion_date, course: @education.course, join_date: @education.join_date } }
